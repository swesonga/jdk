...
public class TestAarch64CallArranger extends CallArrangerTestBase {
    ...
    public void testWindowsVarArgsInRegs() {
        ...
        FunctionDescriptor fd = FunctionDescriptor.ofVoid(C_INT).asVariadic(C_INT, C_FLOAT, C_DOUBLE);
    ...
    public void testWindowsVarArgsInRegsAndOnStack() {
        ...
        FunctionDescriptor fd = FunctionDescriptor.ofVoid(C_DOUBLE).asVariadic(C_INT, C_FLOAT,
        ...
        checkArgumentBindings(callingSequence, new Binding[][]{
            ...
            { vmStore(stackStorage(0), float.class) },
            { vmStore(stackStorage(1), float.class) },
        });
    ...
    @Test
    public void testWindowsMixedArgsInRegs() {
        MethodType mt = MethodType.methodType(void.class, int.class, int.class, float.class, double.class);
    ...
    @Test
    public void testWindowsMixedArgsInRegsAndOnStack() {
        MethodType mt = MethodType.methodType(void.class, double.class, int.class, float.class,
                                              double.class, float.class, float.class, double.class,
    ...
    @Test
    public void testWindowsManyMixedArgsInRegs() {
        MethodType mt = MethodType.methodType(void.class, double.class, int.class, float.class,
                                              double.class, float.class, float.class, double.class,
    ...
    @Test
    public void testWindowsHfa4DoublesInFloatRegs() {
        MemoryLayout struct = MemoryLayout.structLayout(C_DOUBLE, C_DOUBLE, C_DOUBLE, C_DOUBLE);
