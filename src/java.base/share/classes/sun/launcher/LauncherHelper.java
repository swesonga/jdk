...
public final class LauncherHelper {
     ...
     * @param enforceJarVerification if non-zero, JAR files must be signed and
     *                               verified. Currently an int for debugging.
     *
    ...
    public static Class<?> checkAndLoadMain(boolean printToStderr,
        ...
        switch (mode) {
            case LM_MODULE: case LM_SOURCE:
                ...
                break;
            default:
                mainClass = loadMainClass(mode, what, enforceJarVerification);
                break;
        }
    ...
    private static boolean verifyJar(String jarName, int jarVerificationMode) {
        ...
        try {
            ...
            int rc = (int) runMethod.invoke(instance,
                (Object) new String[]{"-verify -strict", jarName});
