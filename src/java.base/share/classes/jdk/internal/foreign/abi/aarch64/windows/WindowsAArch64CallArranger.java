...
public class WindowsAArch64CallArranger extends CallArranger {
    ...
    protected boolean useIntRegsForVariadicFloatingPointArgs() {
        // The Windows ABI requires floating point arguments to be passed in general purpose registers when calling variadic functions
        return true;
    }

    @Override
    protected int maxLayoutSizeOfHFAInGeneralPurposeRegs() {
        return 16;
    }
}