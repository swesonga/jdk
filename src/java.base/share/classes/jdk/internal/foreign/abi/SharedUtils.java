...
public class SharedUtils {
    ...
    public static Linker getSystemLinker() {
        return switch (CABI.current()) {
            ...
            case WindowsAArch64 -> WindowsAArch64Linker.getInstance();
        };
    }
    ...
    public static VaList newVaList(Consumer<VaList.Builder> actions, MemorySession session) {
        return switch (CABI.current()) {
            ...
            case WindowsAArch64 -> WindowsAArch64Linker.newVaList(actions, session);
        };
    }
    ...
    public static VaList newVaListOfAddress(MemoryAddress ma, MemorySession session) {
        return switch (CABI.current()) {
            ...
            case WindowsAArch64 -> WindowsAArch64Linker.newVaListOfAddress(ma, session);
        };
    }
    ...
    public static VaList emptyVaList() {
        return switch (CABI.current()) {
            ...
            case WindowsAArch64 -> WindowsAArch64Linker.emptyVaList();
        };
    }
